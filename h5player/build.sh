...
PATCH="7"                     # our patch counter; bump on every rebuild, reset to 1 on rebase
...
# --- Edit 7: inject the web-fullscreen CSS without GM_addStyle ---------------
...
print('==> edit 7: web-fullscreen CSS injected without GM_addStyle')
